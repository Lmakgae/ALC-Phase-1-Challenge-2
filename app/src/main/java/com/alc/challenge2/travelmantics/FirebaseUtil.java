...
public class FirebaseUtil {
    ...
    public static boolean showedWelcomeToast = false;


    public static void openFbReference(String ref, final ListDealsActivity callerActivity) {
